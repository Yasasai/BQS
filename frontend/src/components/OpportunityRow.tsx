                ...
                <div className="flex flex-col gap-1 items-end mt-1" onClick={e => e.stopPropagation()}>
                    <div className="flex gap-2">
                        ...
                        {role === 'GH' && (
                            <>
                                <AssignButton
                                    onClick={() => onAssign(opp, 'PH')}
                                    label={opp.assigned_practice_head ? "Reassign PH" : "Assign PH"}
                                />
                                <AssignButton
                                    onClick={() => onAssign(opp, 'SH')}
                                    label={opp.assigned_sales_head ? "Reassign SH" : "Assign SH"}
                                />
                            </>
                        )}
