        ...
        <>
            ...
            >
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '8px 0' }}>
                    ...
                    <MenuItem
                        icon={<Inbox size={18} />}
                        label="New Opportunities (Initial)"
                        onClick={() => handleNavigation('/management/new-opportunities')}
                    />

                    <MenuItem
                        icon={<CheckSquare size={18} />}
                        label="Final Approvals"
                        onClick={() => handleNavigation('/management/approvals')}
                    />

                    <MenuItem
                        icon={<Users size={18} />}
                        label="Team Performance"
                        onClick={() => handleNavigation('/management/team')}
                    />
                    ...
                    <MenuItem
                        ...
                        label="Assign to SA"
                        onClick={() => handleNavigation('/practice-head/assign')}
                    />
                    ...
                    <MenuItem
                        ...
                        onClick={() => handleNavigation('/practice-head/metrics')}
                    />
                    ...
                    <MenuItem
                        ...
                        onClick={() => handleNavigation('/sa/assess')}
                    />
