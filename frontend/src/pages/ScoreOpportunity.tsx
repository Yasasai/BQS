...
import { ArrowLeft, Save, Send, AlertTriangle, FileText, Upload, Trash2, CheckCircle, Edit3 } from 'lucide-react';
...
export const ScoreOpportunity: React.FC = () => {
    ...
    const handleReopen = async () => {
        ...
        setIsSaving(true);
        try {
            await axios.post(`http://localhost:8000/api/scoring/${id}/reopen`);
            ...
            <header className="assessment-header">
                <div className="header-title-group">
                    ...
                    <div>
                        <h1 style={{ fontFamily: '"Libre Baskerville", serif', fontSize: '28px', color: '#333333' }}>
                            {isLocked ? 'View Assessment' : (isEdit ? 'Fill Assessment' : 'New Assessment')}
                        </h1>
                ...
                <div className="flex items-center gap-4">
                    {isLocked && (
                        ...
                        >
                            <Edit3 size={14} /> Re-open for Editing
                        </button>
                    )}
