@echo off
echo ================================================================
echo BQS DASHBOARD - STARTUP SCRIPT
echo ================================================================
echo.
...
echo 2. Start Frontend Server (Port 5176)
...
echo API Endpoint: http://127.0.0.1:8000/api/opportunities
...
echo.
cd frontend
echo Frontend will start on: http://localhost:5176
echo.
echo Press Ctrl+C to stop the server
echo.
...
echo Open your browser to: http://localhost:5176
echo.
cd..
pause
goto menu
...
if %errorlevel% == 0 (
    ...
    curl -s http://127.0.0.1:8000/api/opportunities
    echo.
    echo.
    echo ================================================================
    echo If you see data above, opportunities are available!
    echo Open dashboard at: http://localhost:5176
    echo ================================================================
) else (
